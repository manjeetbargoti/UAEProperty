                ...
                <div class="col-lg-9 m-auto">
                    <div class="list_propertybox">
                        <form method="post" name="list_property_form" id="ListProperty"
                            ...
                            <h6 style="color: #000; font-weight: bold; padding-bottom: 0.5em;">Property Basic Details
                            </h6>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="Property Type">Property Type</label> <span
                                        class="badge badge-warning badge-sm">Villa/Residential/Commercial.. etc.</span>
                                    <select name="property_type" id="property_type" class="form-control">
                                        @foreach(\App\PropertyType::where('status', 1)->orderBy('name', 'asc')->get() as
                                        $pt)
                            ...
                            <h6 style="color: #000; font-weight: bold; padding-bottom: 0.5em;">Property Information</h6>
                            <div class="from-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-12">
                                    <label>
                                        ...
                                        Commercial <small class="text-purple pl-1">( If you check this set Commercial
                                            Property )</small>
                                    </label>
                                </div>
                            </div>
                            ...
                            <h6 style="color: #000; font-weight: bold; padding-bottom: 0.5em;">Property Address</h6>

                            <div class="form-row">
                                <div class="form-group col-sm-6">
                                    <label for="inputAddress">Property Address 1</label>
                                    <textarea name="address1" id="address1" rows="3" class="form-control"></textarea>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="inputAddress2">Property Address 2</label> <span
                                        class="badge badge-success badge-sm">Optional</span>
                                    <textarea name="address2" id="address2" rows="3" class="form-control"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="Zipcode/Postal Code">Postal Code</label>
                                    <input name="zipcode" id="zipcode" type="text" class="form-control"
                                        placeholder="Postal Code">
                                </div>
                            </div>

                            <h6 style="color: #000; font-weight: bold; padding-bottom: 0.5em;">Property Images</h6>
                            ...
                            <div class="from-row">
                                <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-inline-block">Submit Property</button>
                                </div>
                            </div>
